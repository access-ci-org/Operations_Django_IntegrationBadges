        ...
        <div className="w-100 p-3 pt-5">
            <Accordion defaultActiveKey={[]}>
                <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                        <p>Participating in ACCESS enables your organization to maximize the use and impact of its
                ...
                <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                        <p>To become an ACCESS Resource Provider, your resource must support research or education, meet
                ...
                <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                        <p>The timeline varies based on the complexity of your resource and the roadmap selected. Simple
                ...
                <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                        <p>You don’t need a dedicated technical team to complete the integration process. While some
                ...
                <Accordion.Item eventKey="4">
                    ...
                    <Accordion.Body>
                        <p>Yes, if you’re considering becoming a Resource Provider and have questions, we encourage you
                ...
                <Accordion.Item eventKey="5">
                    ...
                    <Accordion.Body>
                        <p>We provide hands-on support throughout the onboarding process. This includes access to
                ...
                <Accordion.Item eventKey="6">
                    ...
                    <Accordion.Body>
                        <p>Once your resource is integrated, it becomes part of the national ACCESS ecosystem and is
                ...
                <Accordion.Item eventKey="7">
                    ...
                    <Accordion.Body>
                        <p>There is no fee to become a Resource Provider within ACCESS. The program is fully funded by
                ...
                <Accordion.Item eventKey="8">
                    ...
                    <Accordion.Body>
                        <p>That’s completely okay. We understand that not all resources are the same, and our existing
